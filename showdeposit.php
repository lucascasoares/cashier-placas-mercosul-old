...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">Depósito</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			...
			if($num_rows_print > 0){
				...
				$query_get_username = "SELECT username FROM users WHERE id = '$user_db'";
				$result_get_username = mysqli_query($con,$query_get_username);
				$row_gu = mysqli_fetch_assoc($result_get_username);
				$username = $row_gu['username'];
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
						<div class="panel-heading">
                            Protocolo de depósito: <b><?php echo $id;?></b> <small><em>(criado pelo usuário <b><?php echo $username;?></b> no <b><?php echo $box_name;?></b> da <b><?php echo $establishment_name;?></b>)</em></small>
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="row">
												...
												if($responsible != 0){
													if(connect()){
														...
														if ($cont > 0) {
															...
															echo "<p>Não há responsáveis cadastrados.</p>";
														}
													} else {
										...
										<div class="col-lg-8">
											<center>
												<a href="deposit"><button type="button" class="btn btn-primary">Novo depósito</button></a>
												<a href="printdeposit?id=<?php echo $id;?>"><button type="button" class="btn btn-success">Imprimir</button></a>
											</center>
										</div>
									</div>
								</div>
